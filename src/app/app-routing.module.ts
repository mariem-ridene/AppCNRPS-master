...
const routes: Routes = [
  ...
  },
  {
    path: 'bureau-dordre',
    loadChildren: () =>
      import('./bureau-dordre/bureau-dordre.module').then(
        (m) => m.BureauDordreModule
      ),
  },
  {
    path: 'bureau-daccueil',
    loadChildren: () =>
      import('./bureau-daccueil/bureau-daccueil.module').then(
        (m) => m.BureauDaccueilModule
      ),
  },
  {
    path: 'bureau-de-service',
    loadChildren: () =>
      import('./bureau-de-service/bureau-de-service.module').then(
        (m) => m.BureauDeServiceModule
      ),
  },
  ...
  { path: 'forgot-password', component: ForgotPasswordPageComponent }, // Adding forgot password route
  { path: '', redirectTo: '/login', pathMatch: 'full' }, // Redirect to login by default
  { path: '**', redirectTo: '/login' }, // Handle any unknown paths
];
